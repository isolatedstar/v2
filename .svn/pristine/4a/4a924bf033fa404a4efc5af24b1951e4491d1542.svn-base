...
public class SettleServiceImpl implements ISettleService {
    ...
    public MtSettle selectMtSettleById(String settleId) {
        return mtSettleMapper.selectByPrimaryKey(settleId);
    }

	@Override
	public List<MtSettle> searchPendingSettleForApp(Map<String, Object> map) {
		List<MtSettle> pendingSettleList = mtSettleMapper.searchPendingSettleForApp(map);
		return pendingSettleList;
	}
}