...
public class XmlDispose {
     ...
     * @Title: maptoXml 
     * @author JW
     * @Description: maptoXml
     * @param map
     * @return String
     * @throws
     */
    public  String maptoXml(@SuppressWarnings("rawtypes") Map map) {  
     ...
     * @return 
     */  
    public  String doc2String(org.dom4j.Document document) {  
        String s = "";  
        try {  
            // 使用输出流来进行转化  
