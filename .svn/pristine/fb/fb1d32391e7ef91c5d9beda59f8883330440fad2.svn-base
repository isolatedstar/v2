...
//                }
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [sprintf(that.options.cardView ?
                        '<div class="card-view %s">' : '<td class="bs-checkbox %s" style="text-align: center; vertical-align: middle;">', column['class'] || ''),
                        '<input' +
                        sprintf(' data-index="%s"', i) +
    ...
    BootstrapTable.prototype.loadFromClient = function (data) {
    	var that = this;
    	that.load(data);
    ...
    var allowedMethods = [
        ...
        'updateFormatText','loadFromClient'
    ];
